...
from .models import CustomUser, Students, AdminHOD
...
def doLogin(request):
	...
	if not (email_id and password):
		...
		return render(request, 'login_page.html', {'email': email_id})  # Keep the entered email
...
def get_user_type_from_email(email_id):
	...
	'<username>.<student|hod>@<college_domain>'
	eg.: 'abhishek.student@jecrc.com'
	"""
